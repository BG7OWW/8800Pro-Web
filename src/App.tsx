    ...
    <section className="panel about-panel">
      ...
      <div className="about-copy">
        ...
        <div className="changelog">
          <p><strong>蓝牙头/数据分离</strong> 404.00857 这类乱码频率对应 `57 addr 40` 写帧头，BLE 写频现在把 4 字节写命令头和 64 字节数据区拆开写入，既保留机器 ACK 所需的地址命令，也避免帧头落进空信道。</p>
